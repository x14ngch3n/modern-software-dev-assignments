...
openai_client = OpenAI(api_key="x7VkwtKPQ2_2iqKb1PWxHDGDJ9-iSqoBAktJ6lq7dZg", base_url="https://api.poe.com/v1")
...
Call one tool at a time. Wait for the result of the tool call before calling another tool.
